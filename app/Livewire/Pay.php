...
class Pay extends Component
{
    ...
    public function openModalPayLog()
    {
        ...
        $this->payLogs = PayLogModel::where('status', 'use')->orderBy('id', 'desc')->get();
    }
    ...
    public function openModalPayDelte($id, $name)
    {
    ...
    public function savePayLog(){
        $arrPayLogAmount = $this->payLogAmount;
        foreach ($arrPayLogAmount as $key => $value) {
